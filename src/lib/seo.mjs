...
const ROUTE_TITLES = new Map([
  ...
  ['/blog/rotating-egress-proxy-credentials', 'When the Egress Proxy Rotates Its Credentials | Pilot Blog'],
  ['/blog/end-to-end-encrypted-terminal-sharing-what-the-relay-sees-and-what-it-can-no-lon', 'What an E2E Terminal Relay Sees and Cannot Replay | Pilot'],
  ['/blog/end-to-end-encrypted-terminal-sharing-what-the-relay-can-still-do-after-shell-on', 'What a Terminal Relay Can Still Do After v0.16.1 | Pilot'],
